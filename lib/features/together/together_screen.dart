...
class _LettersSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final totalOpens = sentLetters.fold<int>(0, (sum, l) => sum + l.viewCountOf(partnerUid));
      ...
      child: Column(
        ...
        children: [
          ...
          if (sentLetters.isNotEmpty) ...[
            ...
            Row(
              children: [
                Icon(Icons.remove_red_eye_outlined, color: accent, size: 14),
                const SizedBox(width: 6),
                Text(
                  'Your letters have been opened $totalOpens time${totalOpens == 1 ? '' : 's'} total',
